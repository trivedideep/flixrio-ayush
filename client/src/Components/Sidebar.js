...
const Sidebar = ({ setMenuOpen, darkMode, setDarkMode, setUploadOpen,setFeedbackopen }) => {
    ...
    return (
        <MenuContainer setMenuOpen={setMenuOpen}>
            ...
            {/* Upload button */}
            <Elements onClick={() => handleMenuClick('/favourites')} style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <FavoriteRoundedIcon />
                <NavText>Favourites</NavText>
            </Elements>
            <HR />
            {/* Upload button */}
            <Elements onClick={() => handleMenuClick('/upload')} style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <BackupRoundedIcon />
